...
export const MEDICAL_VERIFIER_ABI = [
  {
    "type": "constructor",
    "inputs": [],
  ...
  {
    "type": "function",
    "name": "currentHealthProfessional",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  {
    "type": "function",
    "name": "currentHealthProfessionals",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  {
    "type": "function",
    "name": "currentManualDaoVerifiers",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  {
    "type": "function",
    "name": "getApplicationProposalDetails",
    "inputs": [
      {
        "name": "applicant",
        "type": "address",
  ...
  {
    "type": "function",
    "name": "getRevocationProposalDetails",
    "inputs": [
      {
        "name": "target",
        "type": "address",
    ...
    "outputs": [
      {
        "name": "vType",
        "type": "uint8",
        "internalType": "enum MedicalVerifier.VerifierType"
      },
      {
        "name": "status",
        "type": "uint8",
        "internalType": "enum MedicalVerifier.ApplicationStatus"
      },
      {
        "name": "docs",
        "type": "tuple",
        "internalType": "struct MedicalVerifier.ApplicationDocs",
        "components": [
          {
            "name": "fullName",
            "type": "string",
  ...
  {
    "type": "function",
    "name": "pendingGenesisApplications",
    "inputs": [
      {
        "name": "",
        "type": "address",
